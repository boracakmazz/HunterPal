...
public class NearestShop extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Snackbar.make(view,"This feature is under development",Snackbar.LENGTH_LONG).show();
        checkPermission = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION);

        if(checkPermission != PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(NearestShop.this,new String[]{Manifest.permission.ACCESS_FINE_LOCATION},100);
